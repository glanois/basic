...
all:	basic.tab.c lex.yy.c \
		...
		next.h next.cpp \
		rem.h rem.cpp \
		multiprogram.h multiprogram.cpp
	...
	data.cpp for.cpp next.cpp rem.cpp multiprogram.cpp \
	-o basic
...
basic.tab.c: basic.y basic.h expression.h stringexpression.h doubleexpression.h \
		...
		goto.h end.h ifthen.h read.h data.h for.h next.h rem.h multiprogram.h
	bison -d basic.y
